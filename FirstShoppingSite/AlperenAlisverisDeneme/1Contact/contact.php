        ...
        <div class="container">
            <div class="main-content">
                <div class="section">
                    ...
                    <p>Location: Turkey</p>
                    <p>Founder: Alperen</p>
                    <p>Website Designer: Alperen</p>
                    <p>Sponsors: <br> Ali Hoca </p>
                    <p>Phone Number: +90 506 198 30 08</p>
                    <p>Company Phone Number: +90 506 198 30 08</p>
                </div>

                <div class="section">
                    <h2>About Us</h2>
                    <p>Founder: Alperen</p>
                    <p>Company: Pumpkin'Sway</p>
                    <p>Company and Founder Story: <br>Wanted to make a personal project.</p>
                    <p>Startup Story: <br>I felt like doing it.</p>
                </div>

                <div class="section">
                    <h2>Our Products</h2>
                    <p>Types of products we sell: <br>Random products from all over the world.</p>
                    <p>Why did we start selling products: <br>Because we can.</p>
                </div>

                <div class="section">
                    <h2>Check Out Our Community</h2>
                    <p>Friends and Close Circle:<br> Dönen Semazenler </p>
                    <p>Join us on <a href="https://telegram.org/tour/groups/tr?ln=a">Telegram</a></p>
                    <p>Join our <a href="https://discord.com/">Discord</a></p>
                </div>
            </div>
        </div>
        <div class="spacesmall"></div>
