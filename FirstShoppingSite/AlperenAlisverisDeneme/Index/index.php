...
$products = [];
$product_sql = "SELECT id, name, price, description, image, image2, image3, answer, question, comments, information FROM urunler";
    ...
    <div class="container">
        <div class="form-container <?php if ($user_logged_in)
            ...
            <form id="userForm" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="info-tooltip">
                        <i class="bx bx-info-circle"></i>
                        <span class="tooltip-text">Password must be at least 8 characters, contain one uppercase letter,
                            one lowercase letter, one number, and one special character (@, $, !, %, *, ?, & or
                            _).</span>
                    </div>
                </div>
        ...
        <?php if ($user_logged_in): ?>
            <div class="product-grid-section">
                            ...
                            <article class="product">
                                ...
                                <div class="info-group" data-product-id="<?php echo $product['id']; ?>">
                                    <button class="info-button" data-product-id="<?php echo $product['id']; ?>"
                                        onclick="toggleProductDetails('info', <?php echo $product['id']; ?>)">Profuct's
                                        Info</button>
                                    <button class="comments-button" data-product-id="<?php echo $product['id']; ?>"
                                        onclick="toggleProductDetails('comments', <?php echo $product['id']; ?>)">Reviews &
                                        Questions</button>
                                </div>
                ...
                <div class="popular-products-button-container">
                    <button id="popular-products-button" class="popular-products-button">
                        <a href="./../Popular/popular.php">See our popular products</a>
                    </button>
                </div>
            </div>
        <?php endif; ?>
